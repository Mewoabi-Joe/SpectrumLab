	...
	initiatePay(data) {
		return new Promise(function (resolve) {
			...
			return __awaiter(this, void 0, void 0, function* () {
				try {
					if (!(data === null || data === void 0 ? void 0 : data.amount)) resolve(error("amount required", 400));
					...
					e.response.data.statusCode =
						(_a = e === null || e === void 0 ? void 0 : e.response) === null || _a === void 0 ? void 0 : _a.status;
		...
		return new Promise(function (resolve) {
			...
			return __awaiter(this, void 0, void 0, function* () {
				try {
					...
					if (!Number.isInteger(data.amount)) resolve(error("amount must be of type integer", 400));
					if (data.amount < 100) resolve(error("amount cannot be less than 100 XAF", 400));
					if (!(data === null || data === void 0 ? void 0 : data.phone)) resolve(error("phone number required", 400));
